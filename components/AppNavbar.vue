<template>
  <header class="sticky top-0 z-40 border-b border-[#EDEDED] bg-white">
    <div class="mx-auto flex h-[80px] w-full max-w-[1216px] items-center justify-between px-4 sm:px-6 lg:px-0">
        ...
        <template v-else>
          ...
          <div class="relative">
            ...
            <div
              ...
              class="absolute right-0 mt-5 w-[308px] bg-[#FEFFFF] rounded-[20px] shadow-[0_4px_15px_rgba(16,24,40,0.12)] border border-[#EDEDED] p-3 z-50 flex flex-col gap-2"
            >
              <NuxtLink
                to="/profile"
                :class="[
              ...
              >
                <!-- Profile Icon (icon-user-circle.svg) -->
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" class="w-5 h-5 shrink-0">
                  <circle cx="10.0003" cy="10.0003" r="8.33333" stroke="currentColor" stroke-width="1.5"/>
                  <path d="M12.0792 7.91634C12.0792 9.06693 11.1452 9.99967 9.99294 9.99967C8.84071 9.99967 7.90664 9.06693 7.90664 7.91634C7.90664 6.76575 8.84071 5.83301 9.99294 5.83301C11.1452 5.83301 12.0792 6.76575 12.0792 7.91634Z" fill="currentColor"/>
                  <path d="M6.25 14.1663C8.19308 12.1312 11.786 12.0354 13.75 14.1663M12.0792 7.91634C12.0792 9.06693 11.1452 9.99967 9.99294 9.99967C8.84071 9.99967 7.90664 9.06693 7.90664 7.91634C7.90664 6.76575 8.84071 5.83301 9.99294 5.83301C11.1452 5.83301 12.0792 6.76575 12.0792 7.91634Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
                </svg>
                <span>Profile</span>
              </NuxtLink>
              ...
              <NuxtLink
                ...
                @click="showProfileDropdown = false"
              >
                <!-- Sticky Note Icon (icon-sticky-note.svg) -->
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" class="w-5 h-5 shrink-0">
                  <path d="M10.2493 2.30293C10.5945 2.91106 10.3897 3.68866 9.79189 4.03977C9.19412 4.39087 8.42976 4.18251 8.08464 3.57438C7.73952 2.96626 7.94433 2.18865 8.5421 1.83755C9.13986 1.48645 9.90422 1.6948 10.2493 2.30293Z" fill="currentColor"/>
                  <path d="M8.84354 4.16706L8.40459 5.83366M10.2493 2.30293C10.5945 2.91106 10.3897 3.68866 9.79189 4.03977C9.19412 4.39087 8.42976 4.18251 8.08464 3.57438C7.73952 2.96626 7.94433 2.18865 8.5421 1.83755C9.13986 1.48645 9.90422 1.6948 10.2493 2.30293Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
                  <path d="M10.833 18.3317C10.0255 17.348 8.74967 15 7.08301 15C6.0078 15.0883 5.44611 16.1342 4.87323 16.9406M4.87323 16.9406C4.54279 16.6342 4.41843 16.1772 4.16972 15.2632L2.71653 9.92283C2.13168 7.77355 1.83925 6.69892 2.33564 5.85232C2.83202 5.00571 3.92337 4.71777 6.10606 4.14187L7.91634 3.66423M4.87323 16.9406C5.20367 17.2471 5.67439 17.3419 6.61584 17.5316L10.0674 18.2271C10.8032 18.3754 10.8098 18.3752 11.5352 18.1838L13.8933 17.5616C16.076 16.9857 17.1673 16.6978 17.6637 15.8511C18.1601 15.0045 17.8677 13.9299 17.2828 11.7806L15.8354 6.46146C15.2505 4.31218 14.9581 3.23755 14.0983 2.74876C13.3493 2.32293 12.4245 2.48663 10.7555 2.91667" stroke="currentColor" stroke-width="1.5"/>
                </svg>
      ...
      >
        <svg v-if="!showMobileMenu" xmlns="http://www.w3.org/2000/svg" class="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    >
      <div v-if="showMobileMenu" class="md:hidden border-t border-gray-100 bg-white px-6 py-6 space-y-6 shadow-xl">
