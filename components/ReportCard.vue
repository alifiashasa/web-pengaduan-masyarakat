<template>
  <div
    class="bg-white rounded-[20px] border border-[#EDEDED] p-5 sm:p-6 shadow-2xs hover:shadow-xs transition-shadow space-y-4"
  >
    <!-- Header: Date & Status -->
    <div class="flex items-center justify-between gap-3">
      <div class="flex items-center gap-2 text-xs sm:text-sm text-[#757575] font-normal">
        <svg
          class="w-4 h-4 text-[#757575] shrink-0"
          viewBox="0 0 24 24"
          fill="none"
          stroke="currentColor"
          stroke-width="1.8"
    ...
    >
      <div
        class="w-8 h-9 bg-[#E53935] rounded-md flex flex-col items-center justify-center shrink-0 shadow-2xs"
      >
        <svg
          width="18"
          height="18"
    ...
    <div
      ...
      class="flex items-center gap-2.5 pt-1 overflow-x-auto pb-1"
    >
      <img
    ...
    <div class="pt-4 border-t border-gray-100 flex items-center justify-between gap-3">
      <div class="flex items-center gap-1.5 text-xs sm:text-sm text-[#757575] font-normal min-w-0">
        <svg
          class="w-4 h-4 shrink-0 text-[#757575]"
          viewBox="0 0 24 24"
          fill="none"
          stroke="currentColor"
          stroke-width="1.8"
