<template>
  <!-- Main Content -->
  <div class="flex-1 flex flex-col items-center justify-center py-12 md:py-16 px-4 text-center">
    <div class="flex flex-col items-center max-w-[800px] mx-auto">
      <EmptyState
        plain
        title="Layanan Sementara Tidak Tersedia"
        description="Halaman ini sementara tidak dapat diakses karena kami sedang melakukan pemeliharaan sistem guna meningkatkan performa, keamanan, dan kenyamanan penggunaan."
      >
        <template #icon>
          <img
...
// SEO Meta details
useHead({
  title: 'Layanan Sementara Tidak Tersedia - Vide',
  meta: [
    {
      name: 'description',
