          ...
          <div class="w-full bg-[#FEFFFF] rounded-[20px] border border-[#EDEDED] p-6 shadow-xs space-y-[20px]">
            ...
            <div>
              <div class="flex items-center justify-between mb-6">
                <div class="flex items-center gap-2.5">
                  <!-- Image Icon -->
                  <img src="/images/icon-pict.svg" alt="Profile Picture" class="w-[21px] h-[21px] shrink-0" />
            ...
            <div class="pt-2">
              <div class="flex items-center gap-2.5 mb-6">
                <!-- Person Icon -->
                <img src="/images/icon-user.svg" alt="Informasi Personal" class="w-6 h-6 shrink-0" />
