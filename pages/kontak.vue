        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-[64px] items-start">
          ...
          <div>
            ...
            <div class="flex items-center gap-2 mb-4">
              <img src="/images/icon-set.svg" alt="" width="22" height="16" />
              <span class="text-[16px] font-semibold text-[#F67011]">Kontak Kami</span>
              <img src="/images/icon-set.svg" alt="" width="22" height="16" />
            </div>

            <!-- Heading -->
            <h1 class="font-urbanist text-[36px] sm:text-[40px] font-semibold leading-[1.15] tracking-[-0.5px] text-[#0A0A0A] mb-4">
              Suara Anda, Prioritas Kami
            </h1>

            <!-- Description -->
            <p class="text-[20px] leading-[1.7] text-[#0A0A0ACC] max-w-[500px] mb-8">
              Setiap saran dan pertanyaan Anda sangat berarti bagi pengembangan Vide. Mari berkolaborasi menciptakan platform laporan yang lebih baik.
            </p>

            <!-- Contact info cards -->
            <div class="flex flex-wrap gap-4">
              <!-- Phone -->
              <div class="w-[266px] h-[60px] flex items-center gap-3 border border-[#EDEDED] rounded-[14px] pl-2 pr-4">
                <div class="w-9 h-9 flex-shrink-0 flex items-center justify-center rounded-[8px] bg-[#F67011]">
                  <img src="/images/icon-telephone.svg" alt="Telepon" width="20" height="20" />
                </div>
                <div>
                  <p class="text-[14px] font-semibold text-[#0A0A0A] leading-[1.4]">Nomor Telepon</p>
              ...
              <div class="w-[266px] h-[60px] flex items-center gap-3 border border-[#EDEDED] rounded-[14px] pl-2 pr-4">
                <div class="w-9 h-9 flex-shrink-0 flex items-center justify-center rounded-[8px] bg-[#F67011]">
                  <img src="/images/icon-email.svg" alt="Email" width="20" height="20" />
                </div>
                <div>
